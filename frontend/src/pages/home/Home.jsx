      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button 
              className="py-3 px-6 bg-[#5C0005] text-white font-medium rounded-lg shadow hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition-colors duration-200 flex items-center justify-center"
